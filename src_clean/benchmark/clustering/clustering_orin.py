...
def parse_args():
    ...
    p.add_argument("--hand_crafted", type=int, default=0, help="Use hand-crafted features for clustering")
...
def main():
    ...
    if args.standardize:
        ...
        print(f"Features standardized. Train shape: {X_train.shape}, Test shape: {X_test.shape}")
        logger.info(f"Features standardized. Train shape: {X_train.shape}, Test shape: {X_test.shape}")
