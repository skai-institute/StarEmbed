...
python -m src.tasks.preproc \
  ...
  --output-dir ./data/processed/run-2 \
  --stars-per-class 100 \
  --class-ids 1 5 \
  --band g \
  --plot
...
python -m src.tasks.train.chronos.generate_data \
  --input-files ./data/processed/run-2/processed_lightcurves.csv \
  --output-file ./data/train/run-2/data/data.arrow
...
python -m src.tasks.eval.forecast.chronos \
  --model-path /home/magics/hdd/sky_ws/skai_universal_forecaster/data/train/run-2/output/overfit/small-crds1/run-0/checkpoint-20000 \
...
python -m src.tasks.preproc \
  --input-file ./data/download/run-2/lightcurves.csv \
  --output-dir ./data/processed/run-3 \
  --stars-per-class 4 \
  --class-ids 1 5 \
  --band g \
  --plot
...
python -m src.tasks.train.chronos.generate_data \
  --input-files ./data/processed/run-3/processed_lightcurves.csv \
  --output-file ./data/train/run-3/data/data.arrow
...
# eval
python -m src.tasks.eval.forecast.chronos \
  --model-path /home/magics/hdd/sky_ws/skai_universal_forecaster/data/train/run-3/output/overfit/small-crds1/run-0/checkpoint-20000 \
  --data-path ./data/processed/run-3/processed_lightcurves.csv \
  --output-dir ./data/eval/run-3/forecast

python -m src.tasks.eval.classification.kmeans \
  --model-path /home/magics/hdd/sky_ws/skai_universal_forecaster/data/train/run-3/output/overfit/small-crds1/run-0/checkpoint-20000 \
  --data-path ./data/processed/run-3/processed_lightcurves.csv \
  --output-dir ./data/eval/run-3/kmeans
